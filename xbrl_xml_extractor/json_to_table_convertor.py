...
if not json_files:
    print(f"[LOG] No JSON files found in {json_folder}")
else:
    print(f"[LOG] Found {len(json_files)} JSON file(s) in {json_folder}")
...
for json_file in json_files:
    ...
    print(f"[LOG] Processing {json_file} ...")
    try:
